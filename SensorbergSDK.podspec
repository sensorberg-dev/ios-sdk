#
#  Be sure to run `pod spec lint SensorbergSDK.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Sensorberg GmbH" => "info@sensorberg.com" }
  ...
  s.source       = { :git => 'https://github.com/sensorberg-dev/ios-sdk.git', :tag => '2.0.2' }
