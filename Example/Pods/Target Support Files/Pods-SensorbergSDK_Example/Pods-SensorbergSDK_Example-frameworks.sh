...
install_framework()
{
  local source="${BUILT_PRODUCTS_DIR}/Pods-SensorbergSDK_Example/$1"
...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework 'GBStorage.framework'
  install_framework 'MSWeakTimer.framework'
  install_framework 'SensorbergSDK.framework'
fi
